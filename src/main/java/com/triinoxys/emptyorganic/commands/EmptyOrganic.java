		        ...
		        if(args.length > 0){
		            ...
		            if(args[0].equalsIgnoreCase("tool")){
		                if(players.contains(p)){
		                    ...
		                    p.sendMessage(prefix
		                            + "§6Vous venez d'§aactiver §6l'outil de sélection.");
		                    ItemStack is = new ItemStack(Material.STICK);
		                    ItemMeta im = is.getItemMeta();
		                    im.setDisplayName("§aOutil de sélection EmptyOrganic");
		                    im.setLore(Arrays.asList("§6Outil de sélection,",
		            ...
		            // Empty
		                ...
		                if(l1.containsKey(p) && l2.containsKey(p)){
		                    ...
		                    p.sendMessage(prefix
		                            + "§cMerci de faire une sélection avant de faire cela !");
		                }
		            }
		            ...
		            // Clear
		                ...
		                clearSelection(p);
		                p.sendMessage(prefix + "§aSélection clear.");
		            }
		            ...
		            // Pos1
		                ...
		                p.sendMessage(prefix + "§aPoint 1 crée");
		            }
		            ...
		            // Pos2
		                ...
		                p.sendMessage(prefix + "§aPoint 2 crée");
		            }
		            ...
		            // Replace
		                ...
		                if(args.length != 3){
		                    p.sendMessage(prefix
		                            + "§c/emptyorganic replace <blocs à remplacés (ex: 1,2:1)> <en ce bloc>");
		                }
		                if(!l1.containsKey(p) || !l2.containsKey(p)){
		                    p.sendMessage(prefix
		                            + "§cMerci de faire une sélection avant de faire cela !");
