...
public class HHCmd implements CommandExecutor{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args){
        if(sender instanceof Player){
            ...
            IChatBaseComponent ts =      ChatSerializer.a("[\"\",{\"text\":\"Teamspeak: \",\"color\":\"gold\",\"bold\":true},{\"text\":\"ts1.privateheberg.fr:10025\",\"color\":\"white\",\"clickEvent\":{\"action\":\"suggest_command\",\"value\":\"ts1.privateheberg.fr:10025\"},\"hoverEvent\":{\"action\":\"show_text\",\"value\":{\"text\":\"\",\"extra\":[{\"text\":\"Cliquez pour copier l'adresse\"}]}}}]");
            ...
            if(Main.lang.containsKey(uuid) && Main.lang.get(uuid).equalsIgnoreCase("en")){
                ts      = ChatSerializer.a("[\"\",{\"text\":\"Teamspeak: \",\"color\":\"gold\",\"bold\":true},{\"text\":\"ts1.privateheberg.fr:10025\",\"color\":\"white\",\"clickEvent\":{\"action\":\"suggest_command\",\"value\":\"ts1.privateheberg.fr:10025\"},\"hoverEvent\":{\"action\":\"show_text\",\"value\":{\"text\":\"\",\"extra\":[{\"text\":\"Click to copy the adress\"}]}}}]");
